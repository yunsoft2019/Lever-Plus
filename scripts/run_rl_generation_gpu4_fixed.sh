...
python -m lever_lm.models.v3.generate_rl_data \
    ...
    --output_path results/okvqa/generated_data/rl_data_v4_50queries_fixed.json \
    ...
    > results/okvqa/generated_data/rl_data_v4_50queries_fixed.log 2>&1
