...
gpu_id=${2:-0}         # GPU ID
grpo_epochs=${3:-50}   # GRPO 训练多少个 epochs（默认 50，与 kl012_balanced 一致）
...
# 输出目录（kl015_balanced_v2，区分于之前的 kl015_balanced）
OUTPUT_DIR="${PROJECT_ROOT}/results/${DATASET_NAME}/model_cpk/v3_RandSampler_Qwen2_5-VL-3B-Instruct_kl015_balanced_v2"
