...
#
# 核心改动：
# 1. 添加可学习的 STOP token，让模型自己决定何时停止选择
# 2. 解决"shot 越多越伤"的问题
# 3. 当模型认为已选够 demo 时，可以提前停止
#
# 训练配置：
...
#
# 使用方法:
#   bash scripts/train_v3_plan_v4_10.sh [gpu_id]
#
# 示例:
#   bash scripts/train_v3_plan_v4_10.sh 4
...
echo "=========================================="
echo "V4-10 方案：STOP 自适应 shot"
echo "=========================================="
echo "核心改动："
echo "  - 添加可学习的 STOP token"
echo "  - 让模型自己决定何时停止选择"
echo "  - 解决 shot 越多越伤 的问题"
echo ""
echo "训练配置："
...
# 输出目录
output_dir="${PROJECT_DIR}/results/okvqa/model_cpk/v3_plan_v4_10"
mkdir -p "$output_dir"
...
# 构建训练命令
train_cmd="CUDA_VISIBLE_DEVICES=${gpu_id} python -m lever_lm.workflows.grpo_post_train_v4_10 \
