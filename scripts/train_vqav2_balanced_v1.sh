#!/bin/bash
# VQAv2 Balanced V1 训练脚本
# 数据特点：571 queries, 54.7% 正样本比例
...
# 数据路径
RL_DATA="${PROJECT_ROOT}/results/vqav2/generated_data/rl_data_balanced_v1.json"
QUERY_EMB="${PROJECT_ROOT}/results/vqav2/cache/query_embeddings.pt"
CKPT_DIR="${PROJECT_ROOT}/results/vqav2/model_cpk/v3_balanced_v1"
