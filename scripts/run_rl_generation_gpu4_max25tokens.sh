#!/bin/bash
# 在 GPU4 上运行 RL 数据生成（修复max_new_tokens=25版本）
...
# 运行 RL 数据生成（使用修复后的代码：max_new_tokens=25）
python -m lever_lm.models.v3.generate_rl_data \
    ...
    --output_path results/okvqa/generated_data/rl_data_v4_50queries_max25tokens.json \
    ...
    > results/okvqa/generated_data/rl_data_v4_50queries_max25tokens.log 2>&1
