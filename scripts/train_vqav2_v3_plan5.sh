...
#
# 使用方法:
#   bash scripts/train_vqav2_v3_plan5.sh [gpu_id]
...
RL_DATA_PATH="${PROJECT_DIR}/results/vqav2/generated_data/rl_data_k64_v3_strict_v3.json"
...
OUTPUT_DIR="${PROJECT_DIR}/results/vqav2/model_cpk/v3_plan5_strict_v3"

echo "=========================================="
echo "VQAv2 方案五训练 (strict_v3 - 放宽筛选)"
echo "=========================================="
echo "  - RL_DATA: rl_data_k64_v3_strict_v3.json (1017 queries)"
echo "  - 正样本比例: 50.3%"
echo "  - KL_BETA=0.1"
echo "  - GRPO_EPOCHS=50"
echo "  - RCE_EPOCHS=5"
