...
#
# 使用方法:
#   bash scripts/train_v3_plan_v4_1_fair.sh [gpu_id]
#
# 示例:
#   bash scripts/train_v3_plan_v4_1_fair.sh 0
...
# 【关键】使用与方案五完全相同的数据文件
RL_DATA_PATH="${PROJECT_DIR}/results/okvqa/generated_data/rl_data_RandSampler_Qwen2_5-VL-3B-Instruct.json"
...
echo ""
echo "训练配置（与方案五完全相同）："
echo "  - RL_DATA: rl_data_RandSampler_Qwen2_5-VL-3B-Instruct.json"
...
# 输出目录（区分于之前的 v3_plan_v4_1）
output_dir="${PROJECT_DIR}/results/okvqa/model_cpk/v3_plan_v4_1_fair"
mkdir -p "$output_dir"
