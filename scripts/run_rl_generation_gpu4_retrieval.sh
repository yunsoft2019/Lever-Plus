#!/bin/bash
# 在 GPU4 上运行 RL 数据生成（使用retrieval方法版本）
...
# 运行 RL 数据生成（使用retrieval方法 + system_prompt + max_new_tokens=25）
python -m lever_lm.models.v3.generate_rl_data \
    ...
    --output_path results/okvqa/generated_data/rl_data_v4_50queries_retrieval.json \
    ...
    > results/okvqa/generated_data/rl_data_v4_50queries_retrieval.log 2>&1
