#!/bin/bash
# VQAv2 Balanced V2 训练脚本
# 数据特点：1894 queries, 50.9% 正样本比例
...
CKPT_DIR="${PROJECT_ROOT}/results/vqav2/model_cpk/v3_balanced_v2"
...
echo "=========================================="
echo "VQAv2 Balanced V2 训练"
echo "=========================================="
echo "数据: ${RL_DATA}"
echo "Query数: 1894"
echo "训练集: 1704, 验证集: 190"
echo "正样本比例: 50.9%"
echo "输出: ${CKPT_DIR}"
echo "GPU: ${GPU_ID}"
echo "=========================================="
