"""
Pointer Selector V4-10 RL: STOP 自适应 shot + 强化学习

继承 V4-10 的 STOP 架构，添加 RCE + GRPO 支持
...
from lever_lm.models.v2.pointer_selector_v4_10 import PointerSelectorV4_10, PointerSelectorV4_10Config


class PointerSelectorV4_10_RL(PointerSelectorV4_10):
    """
    V4-10 RL 版本：STOP 自适应 shot + 强化学习
    ...
    def __init__(
        ...
        print(f"✓ PointerSelectorV4_10_RL 初始化完成（V4-10 + 强化学习）")
    ...
    def compute_rce_loss(
        ...
        if use_top1_only:
            ...
            logits_for_loss = logits.reshape(-1, K_plus_1)
...
class PointerSelectorV4_10_RLConfig(PointerSelectorV4_10Config):
    """V4-10 RL 模型配置类"""
...
def build_model_v4_10_rl(config: Optional[PointerSelectorV4_10_RLConfig] = None) -> PointerSelectorV4_10_RL:
    """构建 V4-10 RL 模型的工厂函数"""
    if config is None:
        config = PointerSelectorV4_10_RLConfig()
    
    return PointerSelectorV4_10_RL(**config.to_dict())
