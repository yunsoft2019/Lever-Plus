#!/usr/bin/env python3
"""
修复 RL 候选池维度一致性 V3：直接用轨迹中的 ICD 构建新候选池
...
使用方法：
    python scripts/fix_rl_candidate_pool_k64_v3.py \
        ...
        --output_path results/okvqa/generated_data/rl_data_k64_v3.json
...
def main():
    parser = argparse.ArgumentParser(description="修复RL候选池维度一致性 V3")
